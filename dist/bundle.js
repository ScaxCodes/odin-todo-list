...
.project {
  background-color: #b9a7a8;
  margin: 10px;
  padding: 10px;
}

.project:hover {
  background-color: #b9a7a899;
  cursor: pointer;
}

.project.active {
  border: 3px solid #738e71;
  padding: 7px;
}
...
.add-button, .save-edit {
  background-color: rgb(90, 177, 90);
}
...
div.add-todo-container input:nth-child(1),
div.add-todo-container input:nth-child(2) {
  margin: 0 0 10px 0;
}

.add-todo-add-button, .add-todo-cancel-button {
  background-color: white;
  padding: 10px;
  border-radius: 5px;
  width: 100px;
...
.add-todo-cancel-button {
  background-color: rgb(209, 101, 101);
}

.add-todo-add-button:hover, .add-todo-cancel-button:hover {
  transform: scale(1.1);
  cursor: pointer;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,4BAA4B;EAC9B,iBAAiB;EACjB,gBAAgB;EAChB,kEAAkE;IAChE,kIAAkI;AACtI;;AAEA;EACE,aAAa;EACb,gCAAgC;EAChC,aAAa;AACf;;AAEA;EACE,yBAAyB;EACzB,aAAa;AACf;;AAEA;EACE,eAAe;EACf,iBAAiB;EACjB,SAAS;AACX;;AAEA;EACE,yBAAyB;EACzB,YAAY;EACZ,aAAa;AACf;;AAEA;EACE,2BAA2B;EAC3B,eAAe;AACjB;;AAEA;EACE,yBAAyB;EACzB,YAAY;AACd;;AAEA;EACE,yBAAyB;EACzB,2BAA2B;EAC3B,iBAAiB;EACjB,YAAY;EACZ,eAAe;EACf,aAAa;EACb,SAAS;EACT,kBAAkB;AACpB;;AAEA;EACE,2BAA2B;EAC3B,eAAe;AACjB;;AAEA;EACE,yBAAyB;EACzB,iBAAiB;EACjB,iBAAiB;EACjB,YAAY;EACZ,eAAe;EACf,aAAa;EACb,SAAS;EACT,kBAAkB;AACpB;;AAEA;EACE,2BAA2B;EAC3B,eAAe;AACjB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,sBAAsB;EACtB,eAAe;EACf,iBAAiB;AACnB;;AAEA;EACE,iBAAiB;EACjB,eAAe;EACf,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,uBAAuB;EACvB,eAAe;EACf,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,YAAY;EACZ,aAAa;EACb,oCAAoC;EACpC,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,eAAe;EACf,WAAW;EACX,YAAY;EACZ,oCAAoC;AACtC;;AAEA;EACE,aAAa;EACb,UAAU;AACZ;;AAEA;EACE,uBAAuB;EACvB,aAAa;EACb,kBAAkB;EAClB,gBAAgB;EAChB,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,iBAAiB;EACjB,kBAAkB;EAClB,YAAY;EACZ,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,kCAAkC;AACpC;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,qBAAqB;EACrB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,YAAY;EACZ,aAAa;EACb,yBAAyB;EACzB,SAAS;AACX;;AAEA;EACE,yBAAyB;EACzB,6BAA6B;AAC/B;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,SAAS;EACT,mBAAmB;EACnB,YAAY;EACZ,aAAa;EACb,yBAAyB;AAC3B;;AAEA;EACE,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,cAAc;EACd,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,cAAc;EACd,kBAAkB;EAClB,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,mBAAmB;EACnB,uBAAuB;EACvB,UAAU;AACZ;;AAEA;EACE,YAAY;EACZ,mBAAmB;EACnB,uBAAuB;EACvB,UAAU;EACV,cAAc;AAChB;;AAEA;EACE,YAAY;EACZ,mBAAmB;EACnB,uBAAuB;EACvB,UAAU;EACV,cAAc;AAChB;;AAEA;;EAEE,kBAAkB;AACpB;;AAEA;EACE,uBAAuB;EACvB,aAAa;EACb,kBAAkB;EAClB,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,kCAAkC;AACpC;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,qBAAqB;EACrB,eAAe;AACjB","sourcesContent":["* {\n    /* box-sizing: border-box; */\n\t\tfont-size: 1.2rem;\n\t\tline-height: 1.5;\n\t\t/* https://css-tricks.com/snippets/css/system-font-stack/ below: */\n    font-family: system-ui, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n}\n\nbody {\n  display: grid;\n  grid-template-columns: 300px 1fr;\n  height: 100vh;\n}\n\n.side-menu {\n  background-color: #e3e3e8;\n  padding: 20px;\n}\n\n.side-header h2 {\n  font-size: 2rem;\n  font-weight: bold;\n  margin: 0;\n}\n\n.project {\n  background-color: #b9a7a8;\n  margin: 10px;\n  padding: 10px;\n}\n\n.project:hover {\n  background-color: #b9a7a899;\n  cursor: pointer;\n}\n\n.project.active {\n  border: 3px solid #738e71;\n  padding: 7px;\n}\n\n.add-project-button {\n  background-color: #738e71;\n  margin: 10px 10px 10px auto;\n  padding: 5px 10px;\n  width: 150px;\n  font-size: 1rem;\n  display: flex;\n  gap: 10px;\n  border-radius: 5px;\n}\n\n.add-project-button:hover {\n  background-color: #738e7199;\n  cursor: pointer;\n}\n\n.add-todo-button {\n  background-color: #738e71;\n  margin: 10px 30px;\n  padding: 5px 10px;\n  width: 150px;\n  font-size: 1rem;\n  display: flex;\n  gap: 10px;\n  border-radius: 5px;\n}\n\n.add-todo-button:hover {\n  background-color: #738e7199;\n  cursor: pointer;\n}\n\n.main {\n  background-color: #ebebef;\n}\n\n.main-header div:nth-child(1) {\n  padding: 20px 20px 0px;\n  font-size: 2rem;\n  font-weight: bold;\n}\n\n.main-header div:nth-child(2) {\n  padding: 0px 20px;\n  font-size: 1rem;\n  font-weight: bold;\n}\n\n.popup {\n  display: none;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  position: fixed;\n  top: 40%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  width: 900px;\n  height: 350px;\n  background-color: rgb(162, 162, 162);\n  border-radius: 5px;\n}\n\n.popup-container {\n  display: none;\n  position: fixed;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n\n.popup-container-button-container {\n  display: flex;\n  gap: 100px;\n}\n\n.add-button, .cancel-button {\n  background-color: white;\n  padding: 10px;\n  border-radius: 5px;\n  margin-top: 30px;\n  width: 100px;\n  text-align: center;\n}\n\n.edit-button {\n  padding: 5px 10px;\n  border-radius: 5px;\n  width: 100px;\n  text-align: center;\n  font-size: 0.9rem;\n}\n\n.edit-button:hover {\n  cursor: pointer;\n}\n\n.add-button, .save-edit {\n  background-color: rgb(90, 177, 90);\n}\n\n.cancel-button, .cancel-edit {\n  background-color: rgb(209, 101, 101);\n}\n\n.add-button:hover, .cancel-button:hover {\n  transform: scale(1.1);\n  cursor: pointer;\n}\n\n.todo-container {\n  display: flex;\n  align-items: center;\n  margin: 10px;\n  padding: 10px;\n  background-color: #b9a7a8;\n  gap: 10px;\n}\n\n.todo-container.done {\n  background-color: #968888;\n  text-decoration: line-through;\n}\n\n.todo-icon:hover {\n  cursor: pointer;\n}\n\n.todo-trash:hover {\n  cursor: pointer;\n}\n\n.todo-edit:hover {\n  cursor: pointer;\n}\n\n.add-todo-container {\n  display: flex;\n  gap: 20px;\n  align-items: center;\n  margin: 10px;\n  padding: 10px;\n  background-color: #b9a7a8;\n}\n\n.todo-icon {\n  display: flex; \n  align-items: center;\n}\n\n.todo-icon img {\n  height: 16px;\n}\n\n.todo-trash {\n  display: flex; \n  align-items: center;\n}\n\n.todo-trash img {\n  height: 20px;\n}\n\n.todo-edit {\n  display: flex; \n  align-items: center;\n}\n\n.todo-edit img {\n  height: 20px;\n}\n\n.todo-title {\n  font-size: 80%;\n  font-weight: 500;\n  margin: 0 10px 0 0;\n}\n\n.todo-description {\n  font-size: 80%;\n}\n\n.todo-due-date {\n  font-size: 80%;\n  font-style: italic;\n  margin: 0 0 0 auto;\n}\n\ndiv.popup input {\n  margin: 0 0 10px 0;\n  padding: 5px;\n  border-radius: 10px;\n  border: 2px solid black;\n  width: 80%;\n}\n\ndiv.add-todo-container input {\n  padding: 5px;\n  border-radius: 10px;\n  border: 2px solid black;\n  width: 80%;\n  font-size: 80%;\n}\n\ndiv.todo-container input {\n  padding: 5px;\n  border-radius: 10px;\n  border: 2px solid black;\n  width: 80%;\n  font-size: 80%;\n}\n\ndiv.add-todo-container input:nth-child(1),\ndiv.add-todo-container input:nth-child(2) {\n  margin: 0 0 10px 0;\n}\n\n.add-todo-add-button, .add-todo-cancel-button {\n  background-color: white;\n  padding: 10px;\n  border-radius: 5px;\n  width: 100px;\n  text-align: center;\n}\n\n.add-todo-add-button {\n  background-color: rgb(90, 177, 90);\n}\n\n.add-todo-cancel-button {\n  background-color: rgb(209, 101, 101);\n}\n\n.add-todo-add-button:hover, .add-todo-cancel-button:hover {\n  transform: scale(1.1);\n  cursor: pointer;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
